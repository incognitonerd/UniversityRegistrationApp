...
public class RemoveStudentLayoutFactory extends VerticalLayout implements View, Button.ClickListener {
	...
	private void addLayout(){
		removeStudentsButton = new Button(Constants.REMOVE_STUDENT.getString());
		setMargin(true);
	...
	public void buttonClick(ClickEvent event){
		...
		Notification.show(Constants.STUDENT_REMOVE_SUCCESS_TITLE.getString(),
				Constants.STUDENT_REMOVE_SUCCESS_DESCRIPTION.getString(), Type.WARNING_MESSAGE);
